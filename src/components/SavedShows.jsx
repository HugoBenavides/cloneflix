      ...
      <div className="relative flex items-center group">
        ...
        >
          <div className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280] inline-block cursor-pointer relative p-2">
            {movies && movies.map((user, id) => ( //movies && es un render condicional para primero definirlo cuando al principio no hay nada dentro del array por usar el hook useState
              <div
                key={id}
              ...
              >
                <img
                  ...
                  src={`https://image.tmdb.org/t/p/w500/${user?.img}`}
                  alt={user?.title}
                />
